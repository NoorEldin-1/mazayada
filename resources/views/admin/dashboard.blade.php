...
<div class="tiles-4">
    <div class="tile">
        ...
        <div>
            <div class="l">إجمالي المستخدمين</div>
    ...
    <div class="tile">
        ...
        <div>
            <div class="l">طلبات التحقق المعلّقة</div>
    ...
    <div class="tile">
        ...
        <div>
            <div class="l">المزايدات النشطة</div>
...
<div class="card" style="margin-bottom:20px">
    <div class="card-h">
        ...
        <div class="actions"><a href="{{ route('admin.auctions.index') }}" class="btn btn-sm btn-ghost">عرض الكل</a></div>
    </div>
    <div style="overflow-x:auto">
        <table class="tbl">
            <thead>
                <tr><th>العنوان</th><th>الجهة</th><th>الفئة</th><th>السعر</th><th>العروض</th><th>الحالة</th></tr>
            </thead>
            <tbody>
                ...
                <tr class="row-hover">
                    ...
                    <td>{{ $auc->entity?->name_ar ? Str::limit($auc->entity->name_ar, 20) : '—' }}</td>
                    <td>{{ $auc->category?->name_ar ?? '—' }}</td>
...
<div class="card">
    <div class="card-h">
        ...
        <div class="actions"><a href="{{ route('admin.users.index') }}" class="btn btn-sm btn-ghost">عرض الكل</a></div>
    </div>
    <div style="overflow-x:auto">
        <table class="tbl">
            <thead>
                <tr><th>الاسم</th><th>البريد الإلكتروني</th><th>الدور</th><th>حالة KYC</th><th>التسجيل</th></tr>
            </thead>
            <tbody>
