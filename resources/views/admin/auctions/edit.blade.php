...
<form method="POST" action="{{ route('admin.auctions.update', $auction) }}" enctype="multipart/form-data" novalidate>
    ...
    <x-ui.card :title="__('admin.auctions.sec_condition_terms')" class="mb-6">
        ...
        <div class="field">
            ...
            <textarea id="condition_terms_ar" name="condition_terms_ar" class="textarea" rows="6" maxlength="5000">{{ old('condition_terms_ar', $auction->condition_terms_ar) }}</textarea>
        ...
        <div class="field">
            ...
            <textarea id="condition_terms_fr" name="condition_terms_fr" class="textarea" rows="6" maxlength="5000" dir="ltr">{{ old('condition_terms_fr', $auction->condition_terms_fr) }}</textarea>
    ...
    <x-ui.card :title="__('admin.auctions.sec_award_terms')" class="mb-6">
        ...
        <div class="field">
            ...
            <textarea id="award_terms_ar" name="award_terms_ar" class="textarea" rows="6" maxlength="5000">{{ old('award_terms_ar', $auction->award_terms_ar) }}</textarea>
        ...
        <div class="field">
            ...
            <textarea id="award_terms_fr" name="award_terms_fr" class="textarea" rows="6" maxlength="5000" dir="ltr">{{ old('award_terms_fr', $auction->award_terms_fr) }}</textarea>
    ...
    @include('admin.auctions.partials.publication-fields', ['auction' => $auction])
