...
<div class="card">
    <table class="tbl">
        ...
        <tbody>
                                ...
                                <div class="card card-pad" style="background:var(--bg-subtle)">
                                    ...
                                    <form method="POST" action="{{ route('admin.appeals.respond', $appeal) }}">
                                        ...
                                        <div style="display:flex;gap:0.5rem">
                                            <button type="submit" name="status" value="RESOLVED" class="btn btn-sm" style="background:#10b981;color:#fff">{{ __('appeals.accept') }}</button>
                                            <button type="submit" name="status" value="REJECTED" class="btn btn-sm" style="background:#ef4444;color:#fff">{{ __('appeals.reject') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            @empty
                <tr>
                    <td colspan="7" style="text-align:center;padding:2rem;color:var(--ink-muted)">{{ __('appeals.none') }}</td>
                </tr>
            @endforelse
        </tbody>
    </table>
