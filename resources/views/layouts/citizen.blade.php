...
<header class="hd hd-cz">
    <div class="hd-inner">
        ...
        {{-- Nav --}}
        <nav class="hd-nav">
            <a href="/" class="hd-link">{{ __('nav.home') }}</a>
            <a href="/auctions" class="hd-link">{{ __('nav.browse_auctions') }}</a>
        </nav>
    ...
    <aside class="cz-side">
        ...
        <div class="cz-side-user">
            ...
            <div class="cz-side-user-info">
                ...
                <div class="cz-side-role">{{ __('dashboard.account_user') }}</div>
            </div>
        </div>
