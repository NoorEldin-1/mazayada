                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e6eae8;">
                    ...
                    <tr>
                        <td style="padding:32px;text-align:{{ locale_dir() === 'rtl' ? 'right' : 'left' }};">
                            <p style="margin:0 0 10px;font-size:16px;color:#111827;font-weight:600;">{{ __('mail.otp.greeting', ['name' => $user->name]) }}</p>
                            <p style="margin:0 0 24px;font-size:14px;line-height:1.7;color:#4b5563;">{{ __('mail.otp.intro') }}</p>

                            <div style="text-align:center;margin:0 0 24px;">
                                <div style="font-size:12px;color:#6b7280;margin-bottom:10px;">{{ __('mail.otp.code_label') }}</div>
                            ...
                            <p style="margin:0 0 8px;font-size:13px;color:#b45309;">{{ __('mail.otp.expiry', ['minutes' => $expiresInMinutes]) }}</p>
                            <p style="margin:0;font-size:13px;line-height:1.7;color:#6b7280;">{{ __('mail.otp.ignore') }}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:18px 32px;background:#f9fafb;border-top:1px solid #eef1f0;text-align:center;">
                            <p style="margin:0;font-size:12px;color:#9ca3af;">{{ __('mail.otp.footer') }}</p>
                        </td>
                    </tr>
                </table>
            </td>
