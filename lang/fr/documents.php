...
return [
    ...
    // ===== Reçu de participation (edits 21 · 22) =====
    'participation_receipt' => [
        'title' => 'Reçu de participation — enchère n° :ref',
        'auction_section' => 'Informations sur l\'enchère',
        'reference' => 'N° / référence de l\'enchère',
        'wilaya' => 'Wilaya',
        'session_round' => 'N° de séance',
        'start_time' => 'Date de début',
        'end_time' => 'Date de fin',
        'opening_price' => 'Mise à prix',
        'citizen_section' => 'Informations sur le citoyen',
        'participation_section' => 'Informations de participation',
        'participant_no' => 'N° de participant',
        'registered_at' => 'Date d\'inscription',
        'deposit' => 'Caution payée',
        'book_price' => 'Prix du cahier des charges',
        'book_free' => 'Gratuit',
        'payment_ref' => 'Référence du paiement',
        'legal_notice' => 'Ce reçu atteste l\'inscription du participant après confirmation du paiement de la caution ; son authenticité se vérifie via le code QR.',
    ],

    // ===== Reçu de résultat (edit 23) =====
    'auction_result' => [
        'title' => 'Reçu de résultat de l\'enchère n° :ref',
        'auction_section' => 'Informations sur l\'enchère',
        'result_section' => 'Résultat de l\'enchère',
        'outcome' => 'Résultat',
        'winner_alias' => 'Adjudicataire (pseudonyme)',
        'final_price' => 'Prix d\'adjudication',
        'bid_count' => 'Nombre d\'offres',
        'bidder_count' => 'Nombre d\'enchérisseurs',
        'citizen_section' => 'Votre position',
        'my_best_bid' => 'Votre meilleure offre',
        'no_bid' => 'Aucune offre de votre part',
        'my_rank' => 'Votre rang',
        'standing' => 'Statut',
        'you_won' => 'Adjudicataire',
        'you_did_not_win' => 'Non adjudicataire',
        'legal_notice' => 'Document informatif sur le résultat de la séance, vérifiable via le code QR ; il ne remplace pas l\'acte d\'adjudication.',
    ],
];
