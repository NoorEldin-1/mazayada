...
return [
    ...
    'logout' => 'Log out',
    'lost_email_recover' => 'Lost your email?',
    'recover_title' => 'Account recovery',
    'recover_subtitle_identify' => 'Enter your NIN and email to reveal your security question.',
    'recover_subtitle_answer' => 'Answer your security question to set a new password.',
    'recover_your_question' => 'Your security question',
    'recover_answer_label' => 'Your answer',
    'recover_continue' => 'Continue',
    'recover_use_email_instead' => 'Use email recovery instead',
    'recover_not_available' => 'Secret-question recovery is not available for these details. Please use email recovery or contact support.',
    'recover_wrong_answer' => 'Incorrect answer.',
    'recover_question_fallback' => 'Security question',
    'two_factor_title' => 'Set up two-factor authentication',
    'two_factor_intro' => 'Platform staff must enable two-factor authentication before accessing the admin dashboard.',
    'two_factor_required' => 'Two-factor authentication is required to continue.',
    'two_factor_enabled' => 'Two-factor authentication is enabled on your account.',
    'two_factor_go_dashboard' => 'Go to dashboard',
    'two_factor_scan' => 'Scan the QR code with your authenticator app, then enter the 6-digit code.',
    'two_factor_code_label' => 'Verification code',
    'two_factor_confirm' => 'Confirm activation',
    ...
    'secret_questions' => [
        ...
        'fav_teacher' => 'Who was your favourite teacher?',
    ],
];
