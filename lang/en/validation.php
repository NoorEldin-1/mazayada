...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Standard Laravel validation messages plus a shared `attributes` map so
    | field names render in the active language. Keep the key structure
    | identical across ar/en/fr — the LocalizationTest enforces parity.
    |
    */
