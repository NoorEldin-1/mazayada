...
return [
    ...
    */
    ...
    | رسائل مخصّصة للرفع.
    |--------------------------------------------------------------------------
    | post_too_large هي الحالة الوحيدة التي لا يستطيع التحقق العادي بلوغها:
    | يتخلّص PHP من محتوى الطلب قبل إقلاع Laravel، فلا يصل رمز CSRF وتظهر
    | صفحة 419 مضلِّلة. تُترجم في bootstrap/app.php إلى هذه الرسالة.
    */
    'custom' => [
        'upload' => [
            'post_too_large' => 'حجم الملفات المرسلة أكبر مما يقبله الخادم (:max ميجابايت كحد أقصى للطلب الواحد). أزل بعض الصور أو صغّر حجم الفيديو ثم أعد المحاولة.',
            'photos_limit' => 'لا يمكن تجاوز :max صورة لكل مزاد (المتبقي: :remaining). احذف صورة موجودة أولاً.',
            'store_failed' => 'تعذّر حفظ الملفات على الخادم. لم يتم حفظ أي تغيير — يُرجى المحاولة مرة أخرى.',
            'photo_not_found' => 'الملف المطلوب حذفه غير موجود ضمن ملفات هذا المزاد.',
        ],
    ],
